...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <?php echo Form::text('meta_description' , $category->meta_description , ['class'=>'form-control']); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <?php echo Form::text('meta_keywords' , $category->meta_keywords , ['class'=>'form-control']); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            <?php echo Form::submit('بروزرسانی' , ['class'=>'btn btn-success']); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-course\cms\cms\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>