...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/font-awesome.min.css')); ?>">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/adminlte.css')); ?>">
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/blue.css')); ?>">
    <!-- Morris chart -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/morris.css')); ?>">
    <!-- jvectormap -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/jquery-jvectormap-1.2.2.css')); ?>">
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/datepicker3.css')); ?>">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/daterangepicker-bs3.css')); ?>">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/bootstrap3-wysihtml5.min.css')); ?>">
...
<script src=" <?php echo e(asset('assets/admin/js/plugins/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
<!-- Morris.js charts -->
...
<!-- jvectormap -->
<script src="<?php echo e(asset('assets/admin/js/jquery-jvectormap-1.2.2.min.js')); ?>"></script>
<script src=" <?php echo e(asset('assets/admin/js/jquery-jvectormap-world-mill-en.js')); ?>"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo e(asset('assets/admin/js/jquery.knob.js')); ?>"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo e(asset('assets/admin/js/bootstrap3-wysihtml5.all.min.js')); ?>"></script>
<!-- Slimscroll -->
...
<?php /**PATH C:\xampp\htdocs\laravel-course\cms\cms\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>